...
const Articulos = [
  ...
  {cat: 2, nombre: 'Logitech G502', disponible: 3, precio: 100, id:'220', detail: "G502 HERO dispone de un sensor óptico avanzado para máxima precisión de seguimiento, iluminación RGB personalizada, perfiles de juego personalizados, de 200 a 25.600 dpi y pesas reposicionables.", img:"./assets/img/g502.png"},
]
const Container = () => {
